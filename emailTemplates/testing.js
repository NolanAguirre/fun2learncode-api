                                      ...
                                      <tbody>
                                          ...
                                          <td colspan="3" style="border:none">
                                            <table width="100%" cellspacing="0" cellpadding="4" border="0">
                                              <tbody>
                                                ...
                                                <tr>
                                                  <td valign="top">
                                                    Activity: Video Game Design<br>
                                                    Location: Fun 2 Learn Code<br>
                                                    420 Chilsolm Valley drive, Round Rock, TX<br>
                                                    Price: 200
                                                  </td>
                                                  <td valign="top">
                                                      May 7<sup>th</sup> 9:00am-12:00pm<br>
                                                      May 8<sup>th</sup> 9:00am-12:00pm<br>
                                                      May 9<sup>th</sup> 9:00am-12:00pm<br>
                                                      May 10<sup>th</sup> 9:00am-12:00pm<br>
                                                      Jun 3<sup>rd</sup> 12:43pm-1:43pm
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                        ...
                                        <tr>
                                          <td colspan="2" style="border:none" valign="top">
                                            Registration - Nolan Aguirre
                                          </td>
                                          <td style="border:none;text-align:right;width:10%" valign="top">200.00</td>
                                        </tr>
                                        <tr>
                                          <td colspan="2" style="border:none" valign="top">
                                            Late Pickup - Nolan Aguirre
                                          </td>
                                          <td style="border:none;text-align:right;width:10%" valign="top">20.00</td>
                                        </tr>
                                        <tr>
                                          <td colspan="2" style="border:none" valign="top">Total</td>
                                          <td style="border:none;text-align:right;width:10%" valign="top">220.00</td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <table style="border:none;margin-top:10px" width="600px" cellspacing="0" cellpadding="3" border="0">
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td colspan="2" style="border:none" valign="top">220.00</td>
                                        </tr>
                                        <tr>
                                          <td colspan="1" style="border:none" valign="top">Method:</td>
                                          <td colspan="2" style="border:none" valign="top">Visa ending in 4242</td>
                                        </tr>
                                        <tr>
                                          <td colspan="1" style="border:none;width:180px" width="180px" valign="top">
                                              Order ID:
                                          </td>
                                          <td colspan="2" style="border:none" valign="top">2bbe0924-0ef3-444f-bbcc-16a247d74abf</td>
                                        </tr>
                                        <tr>
                                          <td colspan="1" style="border:none;width:180px" width="180px" valign="top">
                                              Stripe recipt link:
                                          </td>
                                          <td colspan="2" style="border:none" valign="top"><a href='https://pay.stripe.com/receipts/acct_1DqX6WJvNjqUYflT/ch_1EAjKDJvNjqUYflTVyvfl2nq/rcpt_Ee1MPUVLR7jrEYOBOjgWGBjQoez8KYc' target='_blank'>click here</a></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
