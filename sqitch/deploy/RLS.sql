...
CREATE POLICY admin_all ON ftlc.attendance TO ftlc_admin_group USING (true) WITH CHECK (true);
...
CREATE POLICY admin_all ON ftlc.event_logs TO ftlc_admin_group USING (true) WITH CHECK (true);
...
CREATE POLICY admin_all ON ftlc.students TO ftlc_admin_group USING (true) WITH CHECK (true);
...
CREATE POLICY admin_all ON ftlc.event_registration TO ftlc_admin_group USING (true) WITH CHECK (true);

ALTER TABLE ftlc.users ENABLE ROW LEVEL SECURITY;

CREATE POLICY is_user ON ftlc.users TO ftlc_user USING (id = ftlc.get_id());
CREATE POLICY admin_all ON ftlc.users TO ftlc_admin_group USING (true) WITH CHECK (true);
...
CREATE POLICY admin_all ON ftlc.payment TO ftlc_admin_group USING (true) WITH CHECK (true);
