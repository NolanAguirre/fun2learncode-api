    ...
    data:[
        {
            ...
            test: (expect, data)=>{return expect(data[Object.keys(data)[0]]).toBe('420.00')}
        },{
            ...
            test: (expect, data)=>{return expect(data[Object.keys(data)[0]]).toBe('230.00')}
        },{
            ...
            test: (expect, data)=>{return expect(data[Object.keys(data)[0]]).toBe("9.00")}
        },{
